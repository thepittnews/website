<?php
/**
* WP Post Template: Silhouettes 2018
*/
...
<nav>
  <div class="nav-wrapper">
		<a href="https://pittnews.com">
			<img id="siteLogo" class="left" src="http://pittnews.com/wp-content/uploads/2018/03/TPN-VECTOR-BLUE-small.png" style="width:200px;">
		</a>
...
<div class="row">
	...
	<div class="col s12">
		...
		<span id="author-info" class="meta-info">
			...
			echo '<form style="display:inline;" action="https://www.pittnews.com/writers/" method="POST"><input type="radio" name="theWriterValue" value="' . get_post_meta($post->ID, 'writer', true) . '" checked><a '; echo 'id="authorButton"'; echo 'onclick="javascript:this.parentNode.submit();" href="#" id="theWriter">';
			echo 'Written by ' . $writer[0] . " " . $writer[1];
			if (count($writer) > 2) {
				for ($i = 2; $i < count($writer); $i++) {
					echo ' ' . $writer[$i];
				}
			}
			echo "</a></form>";
			echo '<p id="photographer">Photos by ' . $photos[0] . " " . $photos[1];
